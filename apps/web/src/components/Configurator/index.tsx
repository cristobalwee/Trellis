...
import BrandHeader from '../BrandIntake/BrandHeader';
...
const Configurator: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full" data-lenis-prevent="true">
      {isDev && (
        <div className="shrink-0 px-4 py-1 bg-gray-50 border-b border-charcoal/5">
          <button
      ...
      <div className="flex flex-col md:flex-row flex-1 min-h-0">
        ...
        <aside className={`w-full md:w-[400px] shrink-0 flex flex-col border-r border-charcoal/5 min-h-0 ${
